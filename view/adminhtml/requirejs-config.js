...
var config = {
    map: {
        '*': {
            'emailEditor': 'Hryvinskyi_EmailTemplateEditor/js/email-editor',
            'emailEditorTemplateSidebar': 'Hryvinskyi_EmailTemplateEditor/js/email-editor/template-sidebar',
            'emailEditorTemplateEditor': 'Hryvinskyi_EmailTemplateEditor/js/email-editor/template-editor',
            'emailEditorThemeEditor': 'Hryvinskyi_EmailTemplateEditor/js/email-editor/theme-editor',
            'emailEditorPreviewPanel': 'Hryvinskyi_EmailTemplateEditor/js/email-editor/preview-panel',
            'emailEditorVersionHistory': 'Hryvinskyi_EmailTemplateEditor/js/email-editor/version-history',
